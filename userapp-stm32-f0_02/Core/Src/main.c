...
/* USER CODE BEGIN PV */
#define APPLICATION_ADDRESS (uint32_t)0x08023000
#define VECTOR_TABLE_BYTES 48
#define TX_TIMEOUT 1000

/* MUST HAVE FOR OTA IN STM32F0 */
...
int main(void) {
    ...
    for (uint32_t i = 0; i < VECTOR_TABLE_BYTES; i++) {
